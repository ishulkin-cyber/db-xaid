...
const grades: { grade: Grade; label: string; definition: string }[] = [
  ...
  {
    grade: "4a",
    label: "Незначимая гипердиагностика",
    definition:
      "Врач описал находку, которую валидатор не подтвердил, но это не повлекло бы изменений в тактике ведения пациента.",
  },
  {
    grade: "4b",
    label: "Значимая гипердиагностика",
    definition:
      "Ложная находка, которая привела бы к ненужному дообследованию, направлению или лечению. Врач описал то, чего валидатор не подтвердил, и это клинически значимо.",
  },
];
